            ...
            <div class="prices">
              <div class="prices__list">
                  <h3 class="prices__list-title">
                    ...
                    <span class="prices__item-desc">Extras</span>
                    <span class="prices__item-desc">Volume</span>
                    <span class="prices__item-value">Tarif</span>
                  </h3>
                  <ul>
        <?php $extras = [
          [
          ...
          while($i1<6 && $i2 < 2){          
            ...
            <li class="prices__item">          
            <span class="prices__item-desc"><?= $extras[$i1][$i2]; $i2++; ?></span> 
            <span class="prices__item-desc"><?= $extras[$i1][$i2]; $i2++;?></span>              
            <span class="prices__item-value"><?= $extras[$i1][$i2]; $i2++;?> &euro; </span>
            </li>
